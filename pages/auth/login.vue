        ...
        <div class="mt-6">
          <div class="relative">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="px-2 bg-white text-gray-500"> Or Sign Up </span>
            </div>
          </div>
        </div>

        <div class="mt-6">
          <NuxtLink to="/auth/signup" class=" w-full flex justify-center py-2 px-4 border 
              border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-400 
              hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
            Sign Up
          </NuxtLink>
  ...
  methods: {
    async userLogin() {
      try {
        ...
        this.errorMsg = err.response.data.non_field_errors;
      }
    },
  },
};
